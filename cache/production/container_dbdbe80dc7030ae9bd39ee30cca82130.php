...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000c2d4df700007f86e7a689cf(
...
class phpbbtemplatetwiglexer_000000000c2d4df700007f86e7a689cf extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder62d933c9b6b23095226491 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer62d933c9b6b50728154238 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties62d933c9b6ab3624357519 = array(
    ...
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, 'set_environment', array('env' => $env), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;

        return $this->valueHolder62d933c9b6b23095226491->set_environment($env);
    }
    ...
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;

        return $this->valueHolder62d933c9b6b23095226491->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;

        return $this->valueHolder62d933c9b6b23095226491->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer62d933c9b6b50728154238 = $initializer;
    }
    ...
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, '__get', array('name' => $name), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;

        if (isset(self::$publicProperties62d933c9b6ab3624357519[$name])) {
            return $this->valueHolder62d933c9b6b23095226491->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder62d933c9b6b23095226491;
    ...
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;
    ...
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, '__isset', array('name' => $name), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;
    ...
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, '__unset', array('name' => $name), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;
    ...
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, '__clone', array(), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;

        $this->valueHolder62d933c9b6b23095226491 = clone $this->valueHolder62d933c9b6b23095226491;
    }

    public function __sleep()
    {
        $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, '__sleep', array(), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;

        return array('valueHolder62d933c9b6b23095226491');
    }
    ...
    {
        return $this->initializer62d933c9b6b50728154238;
    }
    ...
    {
        return $this->initializer62d933c9b6b50728154238 && ($this->initializer62d933c9b6b50728154238->__invoke($valueHolder62d933c9b6b23095226491, $this, 'initializeProxy', array(), $this->initializer62d933c9b6b50728154238) || 1) && $this->valueHolder62d933c9b6b23095226491 = $valueHolder62d933c9b6b23095226491;
    }
    ...
    {
        return null !== $this->valueHolder62d933c9b6b23095226491;
    }
    ...
    {
        return $this->valueHolder62d933c9b6b23095226491;
    }
