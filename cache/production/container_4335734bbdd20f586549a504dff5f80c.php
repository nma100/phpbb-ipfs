...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000052a4ca9100007f86f9bd24a6(
...
class phpbbtemplatetwiglexer_0000000052a4ca9100007f86f9bd24a6 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder62d9332baf9f7771642741 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer62d9332bafa23781116990 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties62d9332baf986431621770 = array(
    ...
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, 'set_environment', array('env' => $env), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;

        return $this->valueHolder62d9332baf9f7771642741->set_environment($env);
    }
    ...
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;

        return $this->valueHolder62d9332baf9f7771642741->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;

        return $this->valueHolder62d9332baf9f7771642741->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer62d9332bafa23781116990 = $initializer;
    }
    ...
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, '__get', array('name' => $name), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;

        if (isset(self::$publicProperties62d9332baf986431621770[$name])) {
            return $this->valueHolder62d9332baf9f7771642741->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder62d9332baf9f7771642741;
    ...
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;
    ...
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, '__isset', array('name' => $name), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;
    ...
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, '__unset', array('name' => $name), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;
    ...
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, '__clone', array(), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;

        $this->valueHolder62d9332baf9f7771642741 = clone $this->valueHolder62d9332baf9f7771642741;
    }

    public function __sleep()
    {
        $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, '__sleep', array(), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;

        return array('valueHolder62d9332baf9f7771642741');
    }
    ...
    {
        return $this->initializer62d9332bafa23781116990;
    }
    ...
    {
        return $this->initializer62d9332bafa23781116990 && ($this->initializer62d9332bafa23781116990->__invoke($valueHolder62d9332baf9f7771642741, $this, 'initializeProxy', array(), $this->initializer62d9332bafa23781116990) || 1) && $this->valueHolder62d9332baf9f7771642741 = $valueHolder62d9332baf9f7771642741;
    }
    ...
    {
        return null !== $this->valueHolder62d9332baf9f7771642741;
    }
    ...
    {
        return $this->valueHolder62d9332baf9f7771642741;
    }
